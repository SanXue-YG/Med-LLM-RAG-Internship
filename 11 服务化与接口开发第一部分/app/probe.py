...
from app.config import DEFAULT_CONFIG, STAGE11_DIR, Stage11Config
...
def probe_full_dataset(*, check_chroma_collection: bool = False) -> dict[str, Any]:
    ...
    Aligns with notes Q3: chroma_db_full + bm25_full manifest + optional chunks + Ollama.
    """
    repo_root = STAGE11_DIR.parent
